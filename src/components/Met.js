  ...
  return (
    <Fragment>
      <Breadcrumb className="content__breadcrumb">
        ...
        <Breadcrumb.Item active>
          <Link to="/properties">Metody</Link>
        </Breadcrumb.Item>
      </Breadcrumb>

      <Row className="content">
        <Col>
          <h3 className="content__title">Metody</h3>
        </Col>
      </Row>
        ...
        <Row className="software__container">
          <Col>
            <div style={{ padding: 20, color: "#535355" }}>
              ...
              <p style={{ textAlign: "justify" }}>
                I już ostatnia bardzo istotna kwestia dotycząca metod. Mówiłem,
                że metody coś robią. Tak to prawda. Ale tylko pod jednym
                warunkiem. A mianowicie takim, że{" "}
                <strong>zostaną wywołane. </strong> Możemy napisać sobie bardzo
                spektakularną metodę zajmującą - dajmy na to - 10 tysięcy
                linijek kodu - która oblicza odchylenie krzywizny toru lotu
                promu kosmicznego poczas wejścia w pierwszą warstwę atmosfery.
                Możemy ją umieścić w jakimś utworzonym wcześniej obiekcie. I co?
                Nic nam ona nie obliczy. Obliczy dopiero, gdy zostanie wywołana.
                Po odpaleniu Visual Studio mamy od razu w prezencie od
                Microsoftu dużo obiektów i metod. Np. obiekt Console i metodę
                WriteLine. One już są. Gdzieś ukryte, ale są. My ich nie
                napisaliśmy. Czy po uruchomieniu pierwszy raz Visual Studio z
                naszym kodem Quizu i odpaleniu programu, wyświetli Nam się jakiś
                napis w konsoli? Ano nie. Dopiero jak wpisaliśmy
                Console.WriteLine("Cześć Andrzej"). Czyli dopiero, jak
                wywołalismy metodę WriteLine na obiekcie Console.{" "}
                <strong>
                  Pamiętajmy, metody piszemy po to, żeby je później wywołać
                  kiedy potrzeba, aby robiły to, co chcemy aby robiły !!!
                </strong>
              </p>
            </div>
          </Col>
